/**
 * 文件名: LacksRoleDirectiveModel.java
...
/**
 * 功能描述 : freemarker自定义标签lacksRole
 * @author WeiQiangFan
 * @version [版本号,  2018/8/19]
 * @see [相关类/方法]
 * @since [产品/模板版本号]
 */
public class LacksRoleDirectiveModel extends AbstractAttributeDirectiveModel
{
    /**
     * Model Name
     */
    public static final String MODEL_NAME = "lacksRole";
            ...
            throws TemplateException, IOException
    {
        ...
        if (!hasRole)
        {
            ...
            {
                LOGGER.debug("The subject is lack role. Tag body will be evaluated");
            }
        ...
        else
        {
            if (LOGGER.isDebugEnabled())
            {
                LOGGER.debug("The subject is not lack role. Tag body will not be evaluated");
            }
        }
    }
}