/**
 * 文件名: LacksPermissionDirectiveModel.java
...
/**
 * 功能描述 : freemarker自定义标签lacksPermission
 * @author WeiQiangFan
 * @version [版本号,  2018/8/19]
 * @see [相关类/方法]
 * @since [产品/模板版本号]
 */
public class LacksPermissionDirectiveModel extends AbstractAttributeDirectiveModel
{
    /**
     * Model Name
     */
    public static final String MODEL_NAME = "lacksPermission";
            ...
            throws TemplateException, IOException
    {
        ...
        if (!permitted)
        {
            ...
            {
                LOGGER.debug("The subject is lack permitted. Tag body will be evaluated.");
            }
        ...
        else
        {
            if (LOGGER.isDebugEnabled())
            {
                LOGGER.debug("The subject is not lack permitted. Tag body will not be evaluated.");
            }
        }
    }
}