...
/**
 * 功能描述 : freemarker自定义标签guest
 * @author WeiQiangFan
 * @version [版本号,  2018/8/19]
 * @see [相关类/方法]
 * @since [产品/模板版本号]
 */
public class GuestDirectiveModel extends AbstractElementDirectiveModel
{
    /**
     * Model Name
     */
    public static final String MODEL_NAME = "guest";
            ...
            throws TemplateException, IOException
    {
        ...
        else
        {
            if (LOGGER.isDebugEnabled())
            {
                LOGGER.debug("The Subject exists or has a known identity (aka 'principal'). Tag body will not be evaluated.");
            }
        }
    }
}